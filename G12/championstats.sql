...
CREATE TABLE `champs` (
  ...
  `Hitpoints` float(5,2) NOT NULL DEFAULT '0',
...
INSERT INTO `champs` VALUES (2,'Amumu',625.64,98,100,0,53.384,4.8,0.638,2.19,23.544,3.3,32.1,1.25,280,0,0.7,9,84,0,0.2,1,175,0,0.5,6,350,0,0.8,110);
INSERT INTO `champs` VALUES (3,'Annie',511.68,76,334,50,50.41,2.625,0.579,1.36,12.99,4,30,0,220,0,0.8,4,250,0,0.85,8,60,0,0.2,10,425,0,0.8,80);
